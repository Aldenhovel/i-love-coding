    ...
    SampleUniquePtr<nvinfer1::INetworkDefinition>& network, SampleUniquePtr<nvinfer1::IBuilderConfig>& config)
{
    ...
    IElementWiseLayer* opLayer = network->addElementWise(*tensor1, *tensor2, ElementWiseOperation::kPROD);
    assert(opLayer);
...
code_LOG_FILENAME = f"./logs/{inTypeA}_{inTypeB}_{outType}_{data}_kprod.txt"
